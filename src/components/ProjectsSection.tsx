...
const projects = [
  {
    ...
    isNew: true,
    description:
      "Student management system used daily by 450+ hostel residents.",
    tags: ["Web Application", "Database"],
    githubUrl: "#",
    liveUrl: "#",
  },
  {
    ...
    description:
      "Online food ordering system for students with real-time processing.",
  ...
  {
    title: "E-Commerce Platform – Frolics",
    description:
      "Fashion e-commerce platform serving 2000+ customers.",
    tags: ["WordPress", "WooCommerce", "Analytics"],
    githubUrl: "#",
    liveUrl: "#",
  },
  {
    ...
    description:
      "Voice-enabled smart assistant with active voice detection.",
    tags: ["Gemini API", "AI Agent", "UI"],
    githubUrl: "#",
    liveUrl: "#",
  },
  {
    ...
    description:
      "Automated resume generator with pre-designed templates. (Ongoing)",
    tags: ["Web App", "Automation", "Templates"],
    githubUrl: "#",
    liveUrl: "#",
  },
  {
    ...
    tags: ["Responsive Design", "Professional Layout"],
    githubUrl: "#",
    liveUrl: "#",
  },
];
