...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const email = "chaitanyapawar.dev@gmail.com";
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("chaitanyapawar.dev@gmail.com");
    setCopied(true);
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-20">
        ...
        <div className="space-y-8 md:space-y-10">
          <p className="text-foreground/80 leading-relaxed font-light text-lg">
            I'm always interested in new projects, internships, and learning
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+91 8007393407</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/chaitanyapawar-dev" },
                { Icon: Linkedin, href: "https://www.linkedin.com/in/chaitanyapawar02" },
                { Icon: InstagramIcon, href: "https://www.instagram.com/_chaitanya0205/" },
                { Icon: Mail, href: "mailto:chaitanyapawar.dev@gmail.com" },
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
                  href={href}
